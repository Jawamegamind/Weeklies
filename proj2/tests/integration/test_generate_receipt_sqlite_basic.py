    ...
    with tempfile.TemporaryDirectory() as d:
        ...
        for stmt in SCHEMA.strip().split(";"):
            if stmt.strip():
                cur.execute(stmt)
        cur.execute(
            'INSERT INTO "User"(usr_id, first_name, last_name, email, phone) VALUES (100,"Ada","Lovelace","ada@example.com","555-0000")'
        )
        cur.execute(
            'INSERT INTO "Restaurant"(rtr_id, name, address, city, state, zip, phone) VALUES (10,"Tasty Place","123 Main","Raleigh","NC","27606","555-1111")'
        )
        details = {
