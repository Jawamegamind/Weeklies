...
def test_register_login_profile_flow(client):
    ...
    # Correct login
    r = client.post(
        "/login", data={"email": "ab@x.com", "password": "abcdef"}, follow_redirects=False
    )
...
def test_change_password_validations(client, seed_minimal_data):
    ...
    r = client.post(
        ...
        data={"current_password": "", "new_password": "newpass", "confirm_password": "newpass"},
        follow_redirects=False,
    )
    ...
    r = client.post(
        "/profile/change-password",
        data={"current_password": "secret123", "new_password": "123", "confirm_password": "123"},
        follow_redirects=False,
    )
    ...
    r = client.post(
        "/profile/change-password",
        data={"current_password": "secret123", "new_password": "abcdef", "confirm_password": "xyz"},
        follow_redirects=False,
    )
    ...
    r = client.post(
        "/profile/change-password",
        data={"current_password": "nope", "new_password": "abcdef", "confirm_password": "abcdef"},
        follow_redirects=False,
    )
