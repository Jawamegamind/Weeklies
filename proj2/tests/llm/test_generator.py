...
def menugenerator_single_menus():
    ...
    return menugenerator_single_menu1, menugenerator_single_menu2, menugenerator_single_menu3, menugenerator_single_menu4, menugenerator_single_menu5

def test_MenuGenerator_single_no_regression(menugenerator_single_menus):
    menugenerator_single_menu1, menugenerator_single_menu2, menugenerator_single_menu3, menugenerator_single_menu4, menugenerator_single_menu5 = menugenerator_single_menus
...
def test_MenuGenerator_multiple_meals_no_regression(menugenerator_multiple_meals_menus):
    menugenerator_multiple_meals_menu1, menugenerator_multiple_meals_menu2 = menugenerator_multiple_meals_menus
...
def test_MenuGenerator_multiple_meals_out_of_order_no_regression(menugenerator_multiple_meals_oof_menus):
    menugenerator_multiple_meals_oof_menu1, menugenerator_multiple_meals_oof_menu2 = menugenerator_multiple_meals_oof_menus
...
def test_MenuGenerator_multiple_meals_out_of_order_valid_items(menugenerator_multiple_meals_oof_menus):
    menugenerator_multiple_meals_oof_menu1, menugenerator_multiple_meals_oof_menu2 = menugenerator_multiple_meals_oof_menus
    parsed2 = parse_generated_menu(menugenerator_multiple_meals_oof_menu2)
...
def test_MenuGenerator_multiple_meals_out_of_order_correct_meals(menugenerator_multiple_meals_oof_menus):
    menugenerator_multiple_meals_oof_menu1, menugenerator_multiple_meals_oof_menu2 = menugenerator_multiple_meals_oof_menus
    parsed2 = parse_generated_menu(menugenerator_multiple_meals_oof_menu2)
...
def menugenerator_multiple_days_menus():
    ...
    return menugenerator_multiple_days_menu1, menugenerator_multiple_days_menu2, menugenerator_multiple_days_menu3

def test_MenuGenerator_multiple_days_no_regression(menugenerator_multiple_days_menus):
    menugenerator_multiple_days_menu1, menugenerator_multiple_days_menu2, menugenerator_multiple_days_menu3 = menugenerator_multiple_days_menus
...
def menugenerator_multiple_days_multiple_meals_menu():
    menu = generator.update_menu(menu = None, preferences = "high protein,low carb", allergens = "Peanuts,Shellfish", date = "2025-10-14", meal_numbers = [1,2,3], number_of_days = 2)
    return menu
>>>>>>> 7234a1a (fix: remove llm test skip code and fix undefined variable bugs)

@pytest.fixture(scope="module")
def menugenerator_partial_duplicate(menugenerator_multiple_days_multiple_meals_menu):
    menu = generator.update_menu(menu = menugenerator_multiple_days_multiple_meals_menu, preferences = "high protein,low carb", allergens = "Peanuts,Shellfish", date = "2025-10-14", meal_numbers = [2,3], number_of_days = 3)
    return menu

def test_MenuGenerator_multiple_days_multiple_meals_valid_items(menugenerator_multiple_days_multiple_meals_menu):
...
=======
def test_MenuGenerator_multiple_days_multiple_meals_correct_meals(menugenerator_multiple_days_multiple_meals_menu):
>>>>>>> 7234a1a (fix: remove llm test skip code and fix undefined variable bugs)
    parsed = parse_generated_menu(menugenerator_multiple_days_multiple_meals_menu)
...
def test_MenuGenerator_partial_duplicate_no_regression(menugenerator_multiple_days_multiple_meals_menu, menugenerator_partial_duplicate):
>>>>>>> 7234a1a (fix: remove llm test skip code and fix undefined variable bugs)
